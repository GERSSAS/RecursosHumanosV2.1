  ...
  echo "<div class='col-md-6'><br><br><small>No tiene almacenada hoja de vida por el momento*</small></div>";
                ...
                <div class="col-md-12 row justify-content-end">
                    ...
                    <?php  if ($rowformacion==0 and $rowhistorial==0 and $rowhojadevida==0){ 
                            echo "<div style='text-align:right;'class='col-md-12'><h5>Por favor termina de llenar la información requerida para <br> poder aplicar a esta vacante<small class='red'>*</small></h5></div>";
