                           ...
                           <div class="col-md-6">
                              <br>
                                ...
                                <input require id='certificadodeestudio' placeholder="" type="file"
                                    name="form_titulo_profesional" class="eme2 estiloinput form form-control">
                        ...
                        <form enctype="multipart/form-data">
                            <div class="row justify-content-start">
                                ...
                                <div class="col-md-6">
                                   <div></div>
                                   <br>
                                   <label class="titulos negrita">Certificado<label><br>
                                    <a id='consultarcertificado' type='button'
                                        data-url="<?php echo getUrl("Usuario","Ofertas","consultarcertificado",array("id_formacion" => $form['id_formacion']),"ajax")?>"
                                    class='btn btn-primary radios'><i class='fa fa-file'></i></a></div>
