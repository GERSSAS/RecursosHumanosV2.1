    ...
    <form id="registro" class="formulario1 form-box" method="POST"
        ...
        <div class="col-md-12">
            <div id="contenedorname" class="col-md-6">
                ...
                <input id="usu_nombre" type="text" class="form form-control procesobueno" name="usu_nombre" placeholder="">
            ...
            <div id="contenedorlastname" class="col-md-6">
                ...
                <input id="usu_apellido" type="text" class="form form-control procesobueno" name="usu_apellido" placeholder="">
        ...
        <div class="col-md-12">
            ...
            <br>
                ...
                <input id="usu_documento" type="email" class="form form-control procesobueno" name="usu_correo" placeholder="">
