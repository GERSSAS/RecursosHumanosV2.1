...
<div class="eo #contenedor_arriba x_content">
    <div style="text-align:center;" class="x_title">
        ...
        <form id="alertaexperiencia" action="<?php echo getUrl("Usuario","Ofertas","posthistorial");?>" method="post"
                ...
                <div class="">
                    <div class="row justify-content-start">
                        <div id="cont_fecha_inicio" class="col-md-3">
                            ...
                            <input id="hist_fecha_inicio" name="hist_fecha_inicio" value=""
                        ...
                        <div id="cont_fecha_final" class="col-md-3">
                            ...
                            <input id="hist_fecha_fin" name="hist_fecha_fin" value="" 
                                class="fechas oferta estiloinput form-control" type="date">
                        ...
                        <br>
                            ...
                            <label><input type="checkbox" name="hist_trabajoactual" value="si" class="agree">Marque la casilla sí trabaja actualmente en este cargo</label>
                        </div>
                        ...
                        <div class="x_panel justify-content-start col-md-12">
                            <div class="x_title">
                                ...
                                <h3 style="family-weigh:bolder;">ÁREA</h3>
                            </div>
            ...
            <br>
                <input style="float:left;border-radius:5px;" type="submit" class="btn btn-primary" value="Guardar">    
            </div> 
        </form>
                ...
                <div class="x_title">
                    <div class="row justify-content-start">
                        ...
                        <div class="justify-content-start col-md-12">
                            <div class="x_title">
                                <h3 style="family-weigh:bolder;"></h3>
                            </div>

                         <input type="hidden" name="formulario" id="formulario" value="<?php echo  $hist['id_hist']?>">
                            <div style="border-radius:5px;padding:5px 5px 5px 5px;"id='actividadesmore' name='id_hist'  data-url="<?php echo getUrl("Usuario","Ofertas", "actividadesdinamicas",array("id_hist" => $hist['id_hist']), "ajax")?>" class='col-md-12 titulos_negrita efectohover'><label>↓↓Mostrar más↓↓</label>
                            </div>
                            
                            </p><div id='' class='actividadesresult col-md-12'></div>
...
<?php }?>
             </P><div class="col-md-12" style="padding:5px 5px 5px 5px;">
