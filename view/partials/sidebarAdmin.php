<div class="col-md-3 left_col menu_fixed">
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        ...
        <ul class="nav side-menu">
            ...
            <li> <a data-url="<?php echo getUrl("Admin","Aspirante","graficos",false,"ajax");?>" href="<?php echo getUrl("Admin","Aspirante","listado");?>"><i class="fa fa-home"></i>Inicio </a>
            ...
            <ul class="nav child_menu">
                <li><a href="<?php echo getUrl("Admin","Aspirante","entrevistas");?>">Seleccionados</a></li>
            ...
            <li> <a href="<?php echo getUrl("Admin","Aspirante","todosUsuarios");?>"><i class="fa fa-group"></i>Usuarios registrados </a>
            <li> <a href="<?php echo getUrl("Admin","Aspirante","estadoAspirantes");?>"><i class="fa fa-id-card"></i>Estado aspirantes</a>
