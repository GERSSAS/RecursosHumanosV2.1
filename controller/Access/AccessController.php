...
class AccessController
{
    ...
    try {
        ...
        $mail->Username = 'no.reply@gers.com.co';                 // SMTP username
        $mail->Password = 'mylucsnbxtalyhzs';                           // SMTP password
        $mail->SMTPSecure = 'TSL';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port =587;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('no.reply@gers.com.co', 'Soporte Gers');
...
<?php   } ?>
<a href="<?php echo getUrl2("Usuario","Ofertas","consultaregistro");?>" style='' class="btn btn-info">Editar</a></div><br>
<div class='card'>
    <?php
      echo "<div class='card'>
            <div  class='text-center titles card-header'>
...
<div class='card-body'>
    <blockquote class='blockquote mb-0'>
        ...
        <p class="time"><b>Empresa: </b><?php echo $hist['hist_empresa']?></p>
        <p class="time"><b>Descripcion de Actividades: </b><?php echo $hist['hist_descripcion']?></p>
        <p class="time"><b>Cuidad: </b><?php echo $hist['hist_ciudad']?></p>
        <p class="time"><b>Pais: </b><?php echo $hist['hist_pais']?></p>
        <p class="time"><b>Certificado</b></p>
        <p class="time"><a type="button"id='consultarhistorial'name='id_hist'target="_black"
        ...
        ESTUDIOS
           ...
           foreach ($formacion as $form) {              
                           echo"<div class='card-body'>
                            ...
                            <p class='time'><b>Conocimientos Fundamentales:</b> ".$form["form_conocimientos"]."</p>
                            <p class='time'><b>Titulo</b>
                            <p class='time'><a  type='button'id='consultarcertificado'target='_black'
...
<div class='card'>
    <div class='titles text-center card-header '>
        IDIOMAS
           ...
           foreach ($idioma as $idi) {              
                           echo"<div class='card-body'>
                            <blockquote class='blockquote mb-0'>
                            <footer style='text-align:right;'class='blockquote-footer'><b>Fecha graduación: </b><cite title='Source Title'>".$form["form_fecha_fin"]."</cite></footer>
                            <p class='time'><b>".$idi['idi_nombre']."</b></p>
                            <p class='time'><b>Nivel del Idioma :</b> ".$idi["idi_nivel"]."</p>
                            <footer class='blockquote-footer'>Registrado:<cite title='Source Title'>".$form['form_time']."</cite></footer>
                            </blockquote>
        ...
        echo "<a href='". getUrl2("Usuario","Ofertas","idiomas")."'  style='' class='btn btn-info'>Editar</a></div><br>";
        echo "<div class='card'>
            <div  class='text-center titles card-header'>
